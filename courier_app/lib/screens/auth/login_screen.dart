          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Şifre Sıfırlama', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                const Text('E-posta adresinize şifre sıfırlama bağlantısı göndereceğiz.', textAlign: TextAlign.center, style: TextStyle(fontSize: 14, color: AppColors.textSecondary)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    child: Image.asset('assets/images/supercyp_logo.png', width: 150),
                  ),

                  const SizedBox(height: 12),

                  Text('Hoş Geldiniz', style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center),
                  const SizedBox(height: 6),
                  Text('Kurye hesabınıza giriş yapın', style: Theme.of(context).textTheme.bodyMedium, textAlign: TextAlign.center),
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      final curve = Curves.easeOutCubic.transform(_formEntrance.value);
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: TextButton(
                            ...
                            style: TextButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 4), tapTargetSize: MaterialTapTargetSize.shrinkWrap),
                            child: const Text('Şifremi Unuttum?', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
                          ),
                        ),
                        const SizedBox(height: 8),
                        SizedBox(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              child: const Text('Kayıt Ol', style: TextStyle(fontWeight: FontWeight.w700)),
                            ),
                          ],
                        ),
                      ],
