        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: const Color(0xFF00D4FF).withAlpha(60), blurRadius: 15, spreadRadius: 1),
              ],
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
...
class _FuturisticRobotPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(chestCenter, 12, Paint()
      ..shader = RadialGradient(
        colors: [glowColor, glowColor.withAlpha((100 * glowIntensity).toInt()), Colors.transparent],
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(Rect.fromCenter(center: Offset(centerX, size.height - 105), width: 12, height: 8), const Radius.circular(2)),
...
class _AIChatDialogState extends State<_AIChatDialog> {
  ...
  Future<void> _initChat() async {
    ...
    if (existingSessionId != null) {
      ...
      _messages.add(_ChatMessage(role: 'assistant', content: 'Merhaba! Ben admin asistani. Size nasil yardimci olabilirim?', timestamp: DateTime.now()));
    }
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            if (!isUser) ...[
              Container(width: 30, height: 30, decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFF00D4FF), Color(0xFF00FF88)]), borderRadius: BorderRadius.circular(8)), child: const Icon(Icons.smart_toy, color: Colors.white, size: 18)),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFF252540), borderRadius: BorderRadius.circular(18), border: Border.all(color: const Color(0xFF00D4FF).withAlpha(30))),
  ...
  Widget _buildQuickActions() {
    final questions = ['Kullanici nasil onaylanir?', 'Raporlar nerede?', 'Isletme nasil eklenir?'];
    return SizedBox(
      height: 42,
            ...
            child: Theme(
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(hintText: 'Mesajinizi yazin...', hintStyle: TextStyle(color: Colors.white.withAlpha(120), fontSize: 14), border: InputBorder.none, contentPadding: const EdgeInsets.symmetric(horizontal: 18, vertical: 12)),
