...
class _FloatingAIAssistantState extends State<FloatingAIAssistant>
  ...
  void _onTap() {
    ...
    showDialog(
      ...
      builder: (context) =>
          _AIChatDialog(onClose: () => Navigator.of(context).pop()),
    ).then((_) {
      if (mounted) {
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: RadialGradient(
                                colors: [
                                  const Color(0xFF10B981).withAlpha(
                      ...
                      Positioned(
                        ...
                        child: Center(
                          child: Transform.translate(
                            offset: Offset(
                              0,
                              _isChatOpen ? 0 : -_bodyBounceAnimation.value,
                            ),
...
class _FuturisticRobotPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const metalDark = Color(0xFF2d3436),
        metalMid = Color(0xFF636e72),
        metalLight = Color(0xFFb2bec3);
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromCenter(
          center: Offset(centerX, size.height - 105),
          width: 12,
          height: 8,
        ),
  ...
  void _drawLeg(
    ...
    canvas.drawRRect(
      ...
      Paint()
        ...
        ).createShader(const Rect.fromLTWH(-5, 0, 10, 25)),
    );
    canvas.drawCircle(const Offset(0, 25), 5, Paint()..color = dark);
    canvas.drawCircle(
      const Offset(0, 25),
      3,
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(-7, 45, 14, 6),
        const Radius.circular(2),
      ),
      Paint()..color = mid,
    );
    canvas.drawCircle(const Offset(0, 48), 2, Paint()..color = glow);
    canvas.restore();
  }
  ...
  void _drawArm(
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(-4, 0, 8, 20),
        const Radius.circular(3),
      ),
      Paint()..color = dark,
    );
    canvas.drawCircle(const Offset(0, 20), 4, Paint()..color = mid);
    canvas.drawCircle(
      const Offset(0, 20),
      2,
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        const Rect.fromLTWH(-3, 20, 6, 18),
        const Radius.circular(2),
      ),
      Paint()..color = dark,
    );
    canvas.drawCircle(const Offset(0, 40), 5, Paint()..color = mid);
    canvas.drawCircle(
      const Offset(0, 40),
      2,
      Paint()
  ...
  void _drawHead(
    ...
    final headPath = Path()
      ..moveTo(x - 18, y + 15)
      ..lineTo(x - 22, y - 5)
      ..quadraticBezierTo(x - 22, y - 20, x - 10, y - 22)
      ..lineTo(x + 10, y - 22)
      ..quadraticBezierTo(x + 22, y - 20, x + 22, y - 5)
      ..lineTo(x + 18, y + 15)
      ..close();
    canvas.drawPath(
      headPath,
      Paint()
        ..shader =
            LinearGradient(
              ...
              Rect.fromCenter(center: Offset(x, y), width: 44, height: 40),
            ),
    );
    canvas.drawPath(
      headPath,
    ...
    if (isHovered) {
      canvas.drawPath(
        Path()
          ..moveTo(x - 12, y)
          ..quadraticBezierTo(x - 8, y - 6, x - 4, y),
        Paint()
          ..color = glow
          ..style = PaintingStyle.stroke
          ..strokeWidth = 3
      ...
      canvas.drawPath(
        Path()
          ..moveTo(x + 4, y)
          ..quadraticBezierTo(x + 8, y - 6, x + 12, y),
        Paint()
          ..color = glow
          ..style = PaintingStyle.stroke
          ..strokeWidth = 3
  ...
  bool shouldRepaint(_FuturisticRobotPainter oldDelegate) =>
      oldDelegate.walkAnimation != walkAnimation ||
...
class _AIChatDialogState extends State<_AIChatDialog> {
    ...
    if (existingSessionId != null) {
      ...
      _messages.add(
        _ChatMessage(
          role: 'assistant',
          content:
              'Merhaba! Ben arac kiralama asistaniyim. Size nasil yardimci olabilirim?',
    ...
    setState(() {
      ...
      if (response['success'] == true) {
        ...
        _messages.add(
          _ChatMessage(
            role: 'assistant',
            content: 'Uzgunum, bir hata olustu.',
            timestamp: DateTime.now(),
            isError: true,
          ),
        );
  ...
  Future<void> _startNewChat() async {
    ...
    setState(() {
      ...
      _messages.add(
        _ChatMessage(
          role: 'assistant',
          content: 'Yeni sohbet baslatildi.',
          timestamp: DateTime.now(),
        ),
      );
    });
  ...
  Widget _buildHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(color: const Color(0xFF10B981).withAlpha(50)),
        ),
      ),
      child: Row(
        children: [
          ...
          IconButton(
            icon: Icon(Icons.refresh, color: Colors.white.withAlpha(150)),
  ...
  Widget _buildInputArea() {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          top: BorderSide(color: const Color(0xFF10B981).withAlpha(50)),
        ),
      ),
      child: Row(
        children: [
            ...
            child: Theme(
              data: ThemeData.dark().copyWith(
                textSelectionTheme: const TextSelectionThemeData(
                  ...
                  selectionHandleColor: Color(0xFF10B981),
                ),
              ),
              child: Container(
                decoration: BoxDecoration(
