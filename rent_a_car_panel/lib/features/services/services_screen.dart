          ...
          trailing: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () => _showDeleteConfirm(context, ref, service),
              ),
            ],
          ),
        ),
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: [
                    ...
                    _iconDropdownItem('gps_fixed', Icons.gps_fixed, 'GPS'),
                    _iconDropdownItem('child_care', Icons.child_care, 'Cocuk'),
                    _iconDropdownItem('person_add', Icons.person_add, 'Kisi'),
                    _iconDropdownItem('wifi', Icons.wifi, 'WiFi'),
                    _iconDropdownItem('ac_unit', Icons.ac_unit, 'Kar/Klima'),
                    _iconDropdownItem('luggage', Icons.luggage, 'Bagaj'),
                    _iconDropdownItem(
                      'local_car_wash',
                      Icons.local_car_wash,
                      'Yikama',
                    ),
                    _iconDropdownItem('shield', Icons.shield, 'Sigorta'),
