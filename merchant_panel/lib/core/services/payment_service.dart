...
class StripePaymentService extends PaymentService {
  ...
  Future<PaymentResult> processPayment({
    ...
    try {
      ...
      LogService.error('Stripe hatası: $msg', error: e, source: 'payment_service:processPayment');
      return PaymentResult.failed(msg);
    } catch (e, st) {
      LogService.error('Ödeme hatası', error: e, stackTrace: st, source: 'payment_service:processPayment');
