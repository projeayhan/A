  ...
  Widget _buildSuccessView() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Sifre sifirlama baglantisi ${_emailController.text} adresine gonderildi. Lutfen e-postanizi kontrol edin.',
        ...
        TextButton(
          ...
          child: const Text('Tekrar Gonder'),
        ),
      ],
    );
  }
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : const Text('Sifirlama Baglantisi Gonder'),
                ),
              ),
            ],
          ),
