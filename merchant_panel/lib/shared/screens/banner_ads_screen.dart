            ...
            child: Column(
              ...
              children: [
                ...
                TabBar(
                  ...
                  isScrollable: true,
                  tabs: const [Tab(text: 'Paketler'), Tab(text: 'Bannerlarım')],
                ),
              ],
            ),
          ),
...
class _PackagesTab extends ConsumerWidget {
  ...
  void _showPurchaseDialog(
    ...
    showDialog(
      context: context,
      builder: (_) => _PurchaseDialog(package: pkg, onSuccess: onPurchased),
    );
  }
}
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    isPremium ? AppColors.primary : AppColors.surface,
...
class _PurchaseDialogState extends ConsumerState<_PurchaseDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // 1. Banner kaydı oluştur (pending_payment)
      final banner =
          await supabase
              .from('banners')
              .insert({
