...
final myBannersProvider = FutureProvider<List<Map<String, dynamic>>>((
  ...
  final merchantId = _supabase.auth.currentUser?.id;
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ...
                  style: TextStyle(
                    color: CarSalesColors.textSecondaryDark,
                    fontSize: 14,
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: CarSalesColors.surfaceDark,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: isPremium ? CarSalesColors.primary : CarSalesColors.borderDark,
          width: isPremium ? 2 : 1,
        ),
      ),
      child: Column(
        ...
        children: [
          if (isPremium)
            Container(
              ...
              decoration: BoxDecoration(
                color: CarSalesColors.primary.withValues(alpha: 0.15),
          ...
          Text(
            ...
            style: const TextStyle(
              color: CarSalesColors.textTertiaryDark,
              fontSize: 12,
            ),
            maxLines: 2,
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: isPremium
                    ...
                    : CarSalesColors.surfaceDark,
                foregroundColor: isPremium
                    ? Colors.white
                    : CarSalesColors.primary,
                side: isPremium
                    ? null
                    : const BorderSide(color: CarSalesColors.primary),
              ),
...
class _PurchaseDialogState extends ConsumerState<_PurchaseDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (result.isCancelled) {
        // İptal — banner kaydını ve görseli temizle
        try {
      ...
      // Ödeme başarılı — client-side güncelleme (webhook da yapacak)
      await supabase
          .from('banners')
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      backgroundColor: CarSalesColors.surfaceDark,
      title: Text(
        'Banner Satın Al: ${widget.package['name']}',
        style: const TextStyle(color: CarSalesColors.textPrimaryDark),
      ),
      content: SizedBox(
        width: 480,
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  height: 140,
                  decoration: BoxDecoration(
                    color: CarSalesColors.backgroundDark,
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(color: CarSalesColors.borderDark),
...
class _BannerCard extends StatelessWidget {
  ...
  Color _statusColor(String? status) {
    switch (status) {
      ...
      case 'expired':
        return CarSalesColors.textTertiaryDark;
      default:
        return CarSalesColors.textTertiaryDark;
    }
  }
